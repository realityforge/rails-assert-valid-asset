...
class Test::Unit::TestCase
  ...
  # response from the validator service will be cached in the $RAILS_ROOT/tmp/test/assets/markup directory 
  ...
  # the validator service will be cached in the $RAILS_ROOT/tmp/test/assets/css
  # directory to minimize network calls.
  #
...
private
  ...
  def cache_resource(base,resource,extension)
    ...
    output_dir = "#{RAILS_ROOT}/tmp/test/assets/#{base}"
